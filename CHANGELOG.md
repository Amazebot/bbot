...
<a name="1.4.0"></a>
# [1.4.0](https://github.com/Amazebot/bbot/compare/v1.3.2...v1.4.0) (2018-09-29)


### Features

* **server:** Web server with public and message routes ([6ff0d23](https://github.com/Amazebot/bbot/commit/6ff0d23)), closes [#39](https://github.com/Amazebot/bbot/issues/39)
...
* **rocketchat:** Use text as default for msg in quick replies ([8c1ca3b](https://github.com/Amazebot/bbot/commit/8c1ca3b))
