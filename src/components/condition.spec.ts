...
describe('[condition]', () => {
  describe('Expression', () => {
    describe('.fromString', () => {
      it('convert a string in regex format to regex', () => {
        const exp = new conditions.Expression()
  ...
  describe('Conditions', () => {
    describe('constructor', () => {
      ...
      before(() => {
        sinon.spy(conditions.Conditions.prototype, 'add')
      })
      afterEach(() => {
        (conditions.Conditions.prototype.add as sinon.SinonSpy).resetHistory()
      })
      after(() => {
        (conditions.Conditions.prototype.add as sinon.SinonSpy).restore()
      })
      it('given string, adds as given', () => {
        const arg = '/test/'
        new conditions.Conditions(arg)
        const add = (conditions.Conditions.prototype.add as sinon.SinonSpy)
    ...
    describe('.add', () => {
      it('accepts condition', () => {
        const c = new conditions.Conditions()
    ...
    describe('.exec', () => {
      ...
      context('type: `is`', () => {
        it('match whole input', () => {
          const c = new conditions.Conditions({ a: { is: 'foo' } })
