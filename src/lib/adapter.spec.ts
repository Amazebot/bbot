...
class MockAdapter extends bot.adapter.Adapter {
  name = 'mock-adapter'
...
describe('[adapter]', () => {
  ...
  describe('.fromPath', () => {
    it('loads adapter exported at path', () => {
      ...
      expect(test).to.be.an.instanceof(bot.adapter.Adapter)
  ...
  describe('.loadAll', () => {
    ...
    it('keeps loaded adapters in collection', () => {
      ...
      bot.adapter.loadAll()
      expect(bot.adapter.adapters.message).to.be.instanceof(bot.adapter.Adapter)
