...
export class Envelope implements IEnvelope {
   ...
   */
  constructor (options?: IEnvelope, b?: bot.B) {
    if (b) {
  ...
  toRoomName (name: string): Envelope {
    this.room.name = name
    delete this.room.id
    return this
  }
