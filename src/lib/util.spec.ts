...
describe('.parseSchema', () => {
  it('maps internal key values to given schema', () => {
    ...
    expect(bot.util.parseSchema(internal, schema)).to.eql({
  ...
  it('result the target type if given', () => {
    ...
    const converted = bot.util.parseSchema(internal, schema, new Model())
  ...
  it('inherits unmapped attributes from target', () => {
    ...
    const converted = bot.util.parseSchema(internal, schema, internal)
